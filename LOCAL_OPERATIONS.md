...
- **Buy:** 15m entry decisions (`DAY_ENTRY_BAR_SEC=900`) → `process_bar_candidates` arms a trailing-buy intent → confirmed rebound submits through `execute_buy_fifo` (`DAY_TRAILING_BUY_CONFIRMED`)
