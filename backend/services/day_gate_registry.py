...
DAY_GATES: dict[str, GateSpec] = {
    ...
    for g in (
        ...
        GateSpec(
            ...
            "telemetry",
            "strategy_critical",
            "No AllWeather setup this bar — telemetry only; ranked trailing-buy remains live",
        ...
        GateSpec(
            ...
            "telemetry",
            "strategy_critical",
            "AllWeather production route/bucket mismatch — telemetry only",
        ...
        GateSpec(
            ...
            "telemetry",
            "strategy_critical",
            "No-clear-thesis opinion — telemetry only; ranked trailing-buy remains live",
        ...
        GateSpec(
            ...
            "telemetry",
            "strategy_critical",
            "Path-EV / net EV opinion — telemetry only; cannot block ranked trailing-buy",
