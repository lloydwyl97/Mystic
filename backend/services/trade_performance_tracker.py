        ...
        try:
            ...
            query = """
                SELECT
                    ...
                    AVG(pnl) as avg_pnl,
                    AVG(CASE WHEN is_win = 1 THEN pnl END) as avg_win_pnl,
                    AVG(CASE WHEN is_win = 0 THEN pnl END) as avg_loss_pnl,
            ...
            return {
                ...
                "avg_win_pnl": result[4] or 0.0,
                "avg_loss_pnl": result[5] or 0.0,
                "total_pnl": result[6] or 0.0,
                "avg_pnl_pct": result[7] or 0.0,
                "best_trade": result[8] or 0.0,
                "worst_trade": result[9] or 0.0,
